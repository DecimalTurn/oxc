...
# stdout
```
  x scope-manager-plugin(scope): File has 12 scopes: <GlobalScope>, <ModuleScope>, topLevelFunction, <BlockScope>, TopLevelModule, GenericInterface, TestClass, <ClassStaticBlockScope>, <FunctionScope>, <FunctionScope>, <BlockScope>, <BlockScope>
   ,-[files/index.ts:1:1]
 1 | const { a, b, c } = {};
   : ^
 2 | 
